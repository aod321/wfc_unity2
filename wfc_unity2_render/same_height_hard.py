...
try:
    ...
    img_out_path = os.path.join(img_out_folder, f"same_height_hard_{time_stamp}.png")
    cv2.imwrite(img_out_path, img_bgr)
    json_out_path = os.path.join(json_out_folder, f"same_height_hard_{time_stamp}.json")
